...
import { Factory, ChevronLeft, ArrowUpRight, CheckCircle2 } from 'lucide-react';
import Navbar from '../../components/Navbar';
import Footer from '../../components/Footer';

const services = [
  'Food Production — Commercial Scale',
  'Local Consumption & Export Markets',
  'Pharmaceuticals — Regulatory-Compliant',
  'Cosmetics & Personal Care',
  'Packaged Water',
  'Juices & Edible Liquids',
  'Non-Alcoholic Beverages',
  'Quality Assurance & Distribution',
];

const stats = [
  { value: '4', suffix: '+', label: 'Manufacturing Sectors' },
  { value: 'Intl', suffix: ' Standard', label: 'Quality Compliance' },
  { value: 'Local', suffix: ' & Export', label: 'Market Reach' },
  { value: 'Scale', suffix: '', label: 'Commercial Production' },
];
    ...
    <div className="min-h-screen bg-white font-montserrat">
      ...
      <section className="relative min-h-[90vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://media.base44.com/images/public/69f469a2bdfa4bb2e0735f89/58c799957_generated_image.png"
            alt="Products"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-purple-950/90 via-navy/80 to-navy/60" />
        ...
        <div className="relative z-10 w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-12 pb-16 pt-36">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-gold text-[11px] font-bold tracking-[0.35em] uppercase">Subsidiary 05</span>
            </div>
            <h1 className="font-montserrat font-black text-white leading-tight mb-4" style={{ fontSize: 'clamp(2.2rem, 5vw, 5rem)' }}>
              Casa Chanan<br />
              <span className="text-gold font-light">Products Ltd</span>
            </h1>
            <p className="text-white/70 text-lg lg:text-xl font-light italic mb-8">
              Manufacturing Quality. Delivering Value.
            </p>
            <Link
              to="/contact"
        ...
        <div className="absolute right-6 bottom-8 font-montserrat font-black text-white/[0.04] select-none pointer-events-none hidden lg:block" style={{ fontSize: '20rem', lineHeight: 1 }}>05</div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              <h2 className="font-montserrat font-black text-navy mb-6" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)' }}>
                The Group's<br />
                <span className="text-gold font-light">Production &</span><br />
                Manufacturing Arm
              </h2>
              <p className="text-charcoal/70 leading-relaxed text-base mb-6">
                Casa Chanan Products Ltd is the Group's production and manufacturing arm, focused on delivering essential consumer and healthcare goods that meet both local demand and international standards.
              </p>
              <p className="text-charcoal/70 leading-relaxed text-base mb-8">
                Spanning food production, pharmaceutical manufacturing, personal care, and non-alcoholic beverages, the company is positioned to serve Africa's rapidly growing consumer market with quality products built to last.
              </p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.1 }} className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 bg-gold text-white p-5 rounded-sm shadow-lg hidden lg:block">
                <p className="font-montserrat font-black text-2xl">Intl.</p>
                <p className="text-white/80 text-xs tracking-wide uppercase">Standard Quality</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-px bg-gold" />
              <span className="text-gold text-[11px] font-bold tracking-[0.35em] uppercase">What We Make</span>
            </div>
            <h2 className="font-montserrat font-black text-navy" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.5rem)' }}>Product Lines & Capabilities</h2>
          </motion.div>
      ...
      <section className="py-16 bg-navy">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-montserrat font-black text-white text-2xl mb-1">Ready to explore manufacturing partnerships?</p>
            <p className="text-white/50 text-sm">Quality products. African markets. Global standards.</p>
          </div>
